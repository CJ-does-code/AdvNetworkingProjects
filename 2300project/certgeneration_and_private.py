...
def generate_private_key():
    ...
    new_key="./certs_keys/private_key"+str(random.randint(1, 10000000))+".pem"
...
def create_signed_cert(private_key,email, peer_name):
    ...
    subject = x509.Name([
        ...
        x509.NameAttribute(NameOID.LOCALITY_NAME, "Lowell"),
    ...
    new_key="./certs_keys/cert"+str(random.randint(1, 10000000))+".pem"
    with open(new_key, "wb") as f:
